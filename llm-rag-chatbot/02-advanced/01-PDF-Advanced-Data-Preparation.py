...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=5491112702255241&notebook=%2F02-advanced%2F01-PDF-Advanced-Data-Preparation&demo_name=llm-rag-chatbot&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fllm-rag-chatbot%2F02-advanced%2F01-PDF-Advanced-Data-Preparation&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-naval` from the dropdown menu ([open cluster configuration](https://dbc-2eabc4cf-4603.cloud.databricks.com/#setting/clusters/0329-134422-wbx418cr/configuration)). <br />
